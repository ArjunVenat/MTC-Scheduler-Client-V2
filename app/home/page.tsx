        ...
        <div className="relative h-screen">
            ...
            <div className="relative z-10 h-full flex flex-col">
                ...
                <div className="flex flex-grow h-1/2">
                    <div className="w-1/2 flex flex-col items-start justify-center bg-gray-200">
                        <h1 className="mb-4 text-xl font-sans font-bold underline text-center w-full">See the demo video
                            below:</h1>
                    ...
                    <div className="w-1/2 flex flex-col items-start justify-center bg-gray-100">
                        <h1 className="mb-4 text-xl font-sans font-bold underline text-center w-full">Click the button
                            below to view the instructions document:</h1>
                        <div className="flex justify-center w-full">
